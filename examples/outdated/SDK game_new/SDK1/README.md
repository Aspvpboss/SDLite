...
use -DTRACK_ALLOCATIONS when compiling to enable tracking, otherwise it use the non-tracking memtrack malloc, realloc, strdup, and free

-DSTDLIB_ALLOCATIONS

use -DSTDLIB_ALLOCATIONS when compiling to use normal malloc functions
